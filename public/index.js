...
const initEditor = (body, head) => {
  const editor = grapesjs.init({
    ...
    canvas: {
      styles: ['http://localhost:3000/assets/css/headers/style.css', 'http://localhost:3000/assets/css/headers/bootstrap.css'],
    },
  });
...
const fetchHtml = async () => {
  ...
  try {
    ...
    document.querySelector('#gjs').insertAdjacentHTML('afterbegin', head);
    document.querySelector('#gjs').insertAdjacentHTML('afterbegin', body);
    initEditor(body, head);
  } catch (error) {
    console.log(error);
  }
};
